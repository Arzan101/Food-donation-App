  ...
  function FirstPage(){
    ...
    const Collect1 = () =>{ 
      ...
      <link
        ...
        href="https://www.jotform.com/oembed/?format=json&url=https%3A%2F%2Fform.jotform.com%2F230912145770048"
        title="oEmbed Form"
      />
      <link
        rel="alternate"
        type="text/xml+oembed"
        href="https://www.jotform.com/oembed/?format=xml&url=https%3A%2F%2Fform.jotform.com%2F230912145770048"
        title="oEmbed Form"
      />
      ...
      <link
        type="text/css"
        rel="stylesheet"
        href="https://cdn01.jotfor.ms/themes/CSS/5e6b428acc8c4e222d1beb91.css?v=3.3.40780"
      />
      <link
        type="text/css"
        rel="stylesheet"
        href="https://cdn02.jotfor.ms/css/styles/payment/payment_styles.css?3.3.40780"
      />
      <link
        type="text/css"
        rel="stylesheet"
        href="https://cdn03.jotfor.ms/css/styles/payment/payment_feature.css?3.3.40780"
      />
      <style
        type="text/css"
      ...
      <form
        ...
        action="https://submit.jotform.com/submit/230912145770048"
        method="post"
        name="form_230912145770048"
        id={230912145770048}
        acceptCharset="utf-8"
        autoComplete="on"
      >
        <input type="hidden" name="formID" defaultValue={230912145770048} />
          ...
          <ul className="form-section page-section">
            <li id="cid_12" className="form-input-wide" data-type="control_head">
              <div style={{ display: "table", width: "100%" }}>
                <div
                  className="form-header-group hasImage header-large"
                  data-imagealign="Left"
                >
                  <div className="header-logo">
                    <img
                      src="https://www.jotform.com/uploads/khanazzu994/form_files/pfc_clone_6425e6b2cca00.png"
                      alt="Please Select your Role!!"
                      width={314}
            ...
            >
              <div id="cid_3" className="form-input-wide" data-layout="full">
                ...
                <img
                  ...
                  style={{ border: 0 }}
                  src="https://www.jotform.com/uploads/khanazzu994/form_files/%E2%80%94Pngtree%E2%80%943d%20gift%20box%20with%20pink_8102815.642949a604f4b3.50847174.png"
                  tabIndex={0}
                  height="250px"
                  width="250px"
              ...
              <div id="cid_4" className="form-input-wide" data-layout="full">
                <div style={{ textAlign: "center" }}>
                  <img
                    ...
                    className="form-image"
                    style={{ border: 0 }}
                    src="https://img.freepik.com/premium-vector/new-message-concept-landing-page_23-2148314295.jpg?size=626&ext=jpg&ga=GA1.2.459164167.1680426794&semt=ais"
                    tabIndex={0}
                    height="250px"
                    width="250px"
                    data-component="image"
            ...
            <li className="form-line" data-type="control_image" id="id_16">
              <div id="cid_16" className="form-input-wide" data-layout="full">
                <div style={{ textAlign: "center" }}>
                  <img
                    ...
                    className="form-image"
                    style={{ border: 0 }}
                    src="https://www.jotform.com/uploads/khanazzu994/form_files/%E2%80%94Pngtree%E2%80%94delivery%20man%20riding%20scooter%20on_5380726.642eb3bd0cb4e8.55762918.png"
                    tabIndex={0}
                    height="450px"
                    width="500px"
                    data-component="image"
            ...
            <li className="form-line" data-type="control_button" id="id_17">
